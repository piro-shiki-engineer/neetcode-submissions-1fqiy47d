class Solution:
    ...
    Why I cant this problem ?
    - backtraking → backtraking + cache → bottom-up dpのように段階的のように解こうとしたが決定木では表しにくかった
    - index をsetで管理しcircle検出を同時に行えばいいと思ったが、実際には最後と最初を含めた配列をそれぞれ考えれば線形に並んだ問題として解くことができた
    """
