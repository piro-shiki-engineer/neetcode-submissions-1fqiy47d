...
class Solution:
    """
    Task: Return the maximum betfit by trasactinos or not transactions.

    I have no idea at this moment, Let us describ some example to clarify this problem more.
    """
    def maxProfit(self, prices: List[int]) -> int:
        maxP = 0
        left, right = 0, 1
